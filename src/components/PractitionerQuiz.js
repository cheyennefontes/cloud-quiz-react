...
import practitionerQuestions from "../data/practitionerQuestions";
import Estatisticas from "./Estatisticas";

const PractitionerQuiz = () => {
  const [respostas, setRespostas] = useState(Array(practitionerQuestions.length).fill(null));
  const [mostrarRespostas, setMostrarRespostas] = useState(Array(practitionerQuestions.length).fill(false));
  const [mostrarErro, setMostrarErro] = useState(Array(practitionerQuestions.length).fill(false));

  const perguntas = practitionerQuestions;
...
export default PractitionerQuiz;
